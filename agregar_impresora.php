<?php
include('alta_de_impresora.php'); // Includes Login Script
include('session.php');
...
<div class="container">
	...
	<div class="form-group">
		...
		<input class="form-control" id="name" name="printname" placeholder="printname" type="text">
	</div>
	<div class="form-group">
		<label>Descripción :</label>
		<input class="form-control" id="dscripcion" name="descripcion" placeholder="descripcion" type="text">
	</div>
	<?php
